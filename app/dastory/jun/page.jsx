    ...
    <div className='relative top-20'>
      ...
      <section className='flex flex-col justify-center items-center'>
        ...
        <div className='flex md:flex-row flex-col md:justify-between items-start lg:w-[1100px] w-screen'>
          ...
          <div className='lg:text-start font-semibold text-center text-[20px] text-[#7f88e8]'>103동(1.5룸, 2룸)</div>
          <hr className="mt-1 h-0.5 md:bg-[#7f88e8] bg-white border-t-0 bg-neutral-700 opacity-100 w-[160px] dark:opacity-50"/>
       </div>
       <div className='flex flex-col md:h-[40px] h-[10px] justify-end'>
          ...
          <hr className="mt-1 h-0.5 hidden md:block border-t-0 bg-neutral-200 opacity-100 dark:opacity-50 w-[940px]"/>
       </div>
       </div>
       </div>
